    ...
    >
      ...
      <div className="relative pt-28 md:pt-32 px-6 md:px-12 max-w-[1440px] mx-auto">
        <div className="flex items-center justify-between text-xs tracking-[0.3em] uppercase text-[#94A3B8] font-medium">
          <span data-testid="hero-tag-est">EST. SÖDERTÄLJE · 1891</span>
          <span className="hidden md:inline">N 59°11′ · E 17°37′</span>
          <span>VOL. 134 / Heavy Duty Edition</span>
        </div>
      ...
      <div className="relative max-w-[1440px] mx-auto px-6 md:px-12 mt-16 md:mt-24 grid grid-cols-12 gap-6">
        ...
        >
          ...
          >
            Built for
            <br />
            the <span className="text-[#587187]">Long</span>
            <br />
            Haul.
          </h1>
        </motion.div>
        ...
        >
          <p className="text-base md:text-lg text-white/80 leading-relaxed max-w-md">
            One hundred and thirty four years of Swedish engineering — from
            wooden-spoke wagons to battery-electric freight pioneers. This is
            the story of Scania.
          </p>
        </motion.div>
      </div>
      ...
      <div className="relative max-w-[1440px] mx-auto px-6 md:px-12 mt-16 md:mt-24 pb-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
          <div className="flex items-end gap-10">
            <Stat number="134" label="Years of heavy engineering" testid="hero-stat-years" />
            <Stat number="100+" label="Markets worldwide" testid="hero-stat-markets" />
            <Stat number="2040" label="Net-zero fleet ambition" testid="hero-stat-target" />
          </div>
